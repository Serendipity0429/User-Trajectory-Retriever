...
from .models import Post, Comment, Bulletin, DiscussionSettings
...
class BulletinForm(forms.ModelForm):
    attachments = MultipleFileField(required=False)
    is_extension_update = forms.BooleanField(
        required=False,
        label="Chrome Extension Update",
        widget=forms.CheckboxInput(attrs={"class": "form-check-input"}),
    )
    extension_version = forms.CharField(
        required=False,
        label="New Extension Version",
        widget=forms.TextInput(
    ...
    class Meta:
        ...
        widgets = {
            ...
            "send_notification": forms.CheckboxInput(
    ...
    def clean_extension_version(self):
        ...
        if not version_str:
            raise forms.ValidationError(
                "This field is required for an extension update."
            )
