...
urlpatterns = [
    ...
    path('post/<int:pk>/toggle_private/', views.toggle_post_private, name='toggle_post_private'),
    path('post/<int:pk>/toggle_closed/', views.toggle_post_closed, name='toggle_post_closed'),
