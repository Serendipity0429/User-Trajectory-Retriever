...
urlpatterns = [
    ...
    path(
        "post/<int:pk>/toggle_hidden/",
        views.toggle_post_hidden,
        name="toggle_post_hidden",
    ),
    path(
        "post/<int:pk>/toggle_private/",
        views.toggle_post_private,
        name="toggle_post_private",
    ),
    path(
        "post/<int:pk>/toggle_closed/",
        views.toggle_post_closed,
        name="toggle_post_closed",
    ),
    path("post/new/", views.create_post, name="create_post"),
    path("comment/<int:pk>/delete/", views.delete_comment, name="delete_comment"),
    path(
        "comment/<int:pk>/toggle_hidden/",
        views.toggle_comment_hidden,
        name="toggle_comment_hidden",
    ),
    ...
    path(
        "bulletin/<int:pk>/read_status/",
        views.bulletin_read_status,
