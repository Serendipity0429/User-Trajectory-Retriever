...
@register.inclusion_tag('msg_system/templatetags/unread_message_count.html', takes_context=True)
...
@register.inclusion_tag('msg_system/templatetags/message_popover.html', takes_context=True)
