...
class ExtensionVersionForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'version': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g., 3.1.1'}),
            'update_link': forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'https://example.com/update'}),
