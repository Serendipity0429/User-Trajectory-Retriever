...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('update_link', type=str, help='The URL for the update page.')
        parser.add_argument('description', type=str, help='A description of the changes in this version.')
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS(f'Successfully set extension version to {version}.'))
