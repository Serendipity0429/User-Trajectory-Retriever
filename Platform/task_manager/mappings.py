EXPECTED_SOURCES_MAP = {
    ...
    "mapping": {
        ...
        "official_website": "Official Website / Government Site",
        "official_docs": "Official Documentation / Manual",
...
AHA_MOMENT_MAP = {
    ...
    "mapping": {
        ...
        "visual_aid": "Visual Aid (Image / Map / Diagram)",
        "code_snippet": "Code Snippet / Example",
        "official_document": "Official Document / Report",
        "key_definition": "Key Definition / Concept",
        "synthesis_combination": "Synthesis (Combining Facts)",
        "synthesis_inference": "Synthesis (Inference / Deduction)",
        "other": "Other",
    },
}
...
UNHELPFUL_PATHS_MAP = {
    ...
    "mapping": {
        ...
        "info_overload": "<strong>Information Overload:</strong> I found too many results and couldn't filter them.",
        ...
        "language_barrier": "<strong>Language / Terminology Barrier:</strong> The results were too technical or in a language I didn't understand.",
...
STRATEGY_SHIFT_MAP = {
    ...
    "mapping": {
        ...
        "platform_switch": "<strong>Platform Switch:</strong> I switched from one platform to another (e.g., Google to YouTube/Wikipedia).",
...
AHA_MOMENT_EXPLANATION_MAP = {
    ...
    "mapping": {
        ...
        "visual_aid": "The answer was found in an image, map, or diagram.",
        "code_snippet": "The answer was found in a code snippet or example.",
        ...
        "synthesis_combination": "The answer was derived by combining separate facts from different sources or sections.",
        "synthesis_inference": "The answer was derived by inferring a conclusion not explicitly stated.",
...
UNHELPFUL_PATHS_EXPLANATION_MAP = {
    ...
    "mapping": {
        ...
        "info_overload": "You found too many results and couldn't filter them effectively.",
...
STRATEGY_SHIFT_EXPLANATION_MAP = {
    ...
    "mapping": {
        ...
        "platform_switch": "You switched from one platform (e.g., Google) to another (e.g., YouTube, Wikipedia).",
