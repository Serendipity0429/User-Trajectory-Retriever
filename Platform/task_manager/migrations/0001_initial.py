...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="ReflectionAnnotation",
            fields=[
                ("id", models.AutoField(primary_key=True, serialize=False)),
                ("failure_reason", models.CharField(max_length=10000)),
                ("future_plan", models.CharField(max_length=10000)),
            ],
        ),
        migrations.CreateModel(
            name="Task",
            fields=[
                ...
                ("num_trial", models.IntegerField(default=0)),
            ],
        ),
        migrations.CreateModel(
            name="TaskDataset",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="task_manager.reflectionannotation",
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            name="TaskDatasetEntry",
            fields=[
                ("id", models.AutoField(primary_key=True, serialize=False)),
                ("question", models.CharField(max_length=10000)),
                ("answer", models.JSONField()),
                ("num_associated_tasks", models.IntegerField(default=0)),
                (
                    "belong_dataset",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="task_manager.taskdataset",
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to="task_manager.taskdatasetentry",
            ),
        ),
        migrations.AddField(
            model_name="task",
